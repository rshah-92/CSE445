...
<body>
   <form id="form1" runat="server">
	   ...
	   <!-- TryIt: Cookie Demo -->
	   <h2>TryIt Cookie Storage</h2>
	   <div class="tryit-box">
		   <p>
			   <strong>Component:</strong> Cookie save/load using HttpCookie.<br />
			   <strong>Input:</strong> Username + Campus &nbsp;|&nbsp;
			   <strong>Output:</strong> Cookie stored for 10 minutes.
		   </p>

		   Username:
		   <asp:TextBox ID="txtCookieUser" runat="server" style="width:150px;" />
		   &nbsp;&nbsp;
		   Campus:
		   <asp:TextBox ID="txtCookieCampus" runat="server" style="width:150px;" />
		   <br /><br />

		   <asp:Button ID="btnSaveCookie" runat="server" Text="Save Cookie"
               OnClick="btnSaveCookie_Click" />
		   &nbsp;
		   <asp:Button ID="btnLoadCookie" runat="server" Text="Load Cookie"
               OnClick="btnLoadCookie_Click" />

		   <br /><br />
		   <asp:Label ID="lblCookieResult" runat="server" ForeColor="Blue" />
	   </div>


	   <!-- TryIt: DLL Hashing -->
	   <h2>TryIt SHA‑256 Hashing (DLL)</h2>
	   <div class="tryit-box">
		   <p>
			   <strong>Component:</strong> SecurityUtils.ComputeSha256() from Project5_LocalComponents DLL.<br />
			   <strong>Input:</strong> Any string &nbsp;|&nbsp;
			   <strong>Output:</strong> SHA‑256 hash.
		   </p>

		   Text to hash:
		   <asp:TextBox ID="txtHashInput" runat="server" style="width:250px;" />
		   <br /><br />
		   ...
		   <br /><br />
		   <asp:Label ID="lblHashResult" runat="server" ForeColor="Blue" />
	   </div>


	   <!-- TryIt: Weather Service -->
	   <h2>TryIt Weather Web Service</h2>
	   <div class="tryit-box">
		   <p>
			   <strong>Component:</strong> WeatherService.svc<br />
			   <strong>Input:</strong> City + Date &nbsp;|&nbsp;
			   <strong>Output:</strong> Weather string returned by SOAP.
		   </p>

		   City:
		   <asp:TextBox ID="txtCity" runat="server" style="width:150px;" />
		   &nbsp;&nbsp;
		   Date:
		   <asp:TextBox ID="txtDate" runat="server" style="width:150px;" />
		   <br /><br />
		   ...
		   <br /><br />
		   <asp:Label ID="lblWeatherResult" runat="server" ForeColor="Blue" />
	   </div>
